...
declare global {
  ...
  const useRepositories: typeof import('../../composables/state')['useRepositories']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useRepositories: UnwrapRef<typeof import('../../composables/state')['useRepositories']>
